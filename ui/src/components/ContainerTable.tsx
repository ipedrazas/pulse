      ...
      <table className="w-full">
        <thead className="bg-gray-900">
          <tr>
            ...
            <SortHeader label="Image" field="image" />
            <SortHeader label="Status" field="status" />
            <SortHeader label="Node" field="agent_name" />
            <SortHeader label="Uptime" field="uptime_seconds" />
          </tr>
        </thead>
          ...
          {sorted.map((c) => (
            <>
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-gray-400">{formatUptime(c.uptime_seconds)}</td>
              </tr>
